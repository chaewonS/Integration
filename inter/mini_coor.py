...
# B-F 최단경로(이웃 노드 별 거리 수정완)
adjac_lis = {
    #corner : N11&12, N17&18, N27&28
    (12,31): [((12,26), 1155)],
    (12,26): [((12,22), 780),((12,31), 1155)],
    (12,22): [((12,18), 1090),((12,26), 780)], #750 삭제
    (10,18): [((12,18), 528)],
    (12,18): [((10,18),528),((12,22),1090)], #910 삭제
}
graph1 = Graph(adjac_lis)
# graph1.a_star_algorithm((12,31), (10,19)) #출발지~목적지
# graph1.a_star_algorithm((12,22), (10,18))

# graph1.a_star_algorithm((10,18), (12,26))
